...
public class RestException extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        return buildResponseEntity(new ErrorMessage(status, status.value(), error,exceptionAsString));
    }
    ...
    public final ResponseEntity<ErrorMessage> handleProductRestException(ProductException exception, WebRequest request) {

        ErrorMessage errorMessage = new ErrorMessage(exception.getStatus(), exception.getCode(),
